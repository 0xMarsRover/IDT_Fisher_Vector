...
"""
#Path to the video repository (ready to modify)
ucf101_path = "/media/psf/Kellan/video_data_30/data/UCF101"


# Improved Dense Trajectories binary
dtBin = '/home/parallels/Documents/improved_trajectory_release/release/DenseTrackStab'

# Temp directory to store resized videos
tmpDir = '/media/psf/Kellan/video_data_30/tmp'
